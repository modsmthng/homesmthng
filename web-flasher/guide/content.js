  ...
  boards: [
    {
      ...
      case: value("Different housings are available in the smthng display housing collection. No screws are required for the smthng display housing.", link("Browse the case collection", "https://www.printables.com/@dubios42/collections/2861668")),
    ...
    },
    {
      ...
      case: value("Different housings are available in the smthng display housing collection. Use 1.4 mm × 5 mm screws; do not use M2 screws.", link("Browse the case collection", "https://www.printables.com/@dubios42/collections/2861668")),
      usbPower: value("Power the display with 5 V via USB-C. Use a data cable for flashing."),
      rearPinPower: value("Possible through pins on the back. Check LilyGo’s official documentation for the correct pins and voltage before connecting power."),
    ...
    },
    {
      ...
      case: value("Different housings are available in the smthng display housing collection. Use short M2 screws, approximately 4 mm long. Verify the length against the case before tightening.", link("Browse the case collection", "https://www.printables.com/@dubios42/collections/2861668")),
      usbPower: value("Power the display with 5 V via USB-C. Use a data cable for flashing."),
